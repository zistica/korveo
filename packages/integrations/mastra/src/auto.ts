/**
 * Side-effect entry point — `import "@korveo/mastra/auto"` enables
 ...
 * `korveoConfig()` helper — see the package README. This module
...
// caller can re-invoke `installKorveoTracing()` after their
// framework boots, or fall back to `korveoConfig()`.
